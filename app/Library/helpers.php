...
if (!function_exists('check_if_is_non_number_column')) {
    function check_if_is_non_number_column($column_name) {
        ...
        $non_number_headers =[ 'tin', 'employee\'s tin', 'social security number','social_fund_no', 'nssf no.', 'nssf number','nssf','national','national_id','wcf_no', 'wcf no', 'accountno', 'bank accountno', 'bank account no.', 'ref no.'];
